...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">ddd
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="col-lg-4 container jumbotron ">
                     ...
                     <form action="toAdminLogin" class="form-group " method="post">
                    
                        <input class="form-control" type="text" name="user" placeholder="Admin Username"></input>
                                 <br>
                                 <input class="form-control" type="password" name="pass" placeholder="password"></input>
                                 <br>

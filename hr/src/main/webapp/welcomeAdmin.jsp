...
<% response.setHeader("Expires", "0"); %>
    ...
    <div class="wrapper">
        ...
        <div id="content">
           ...
           <%
        	try{
           		String query1 = "select distinct user_id from feedback_answer;";
				...
				<table class="table striped hover">
					...
					while(rs1.next()){
						...
						String query2="select username from user where id="+id;
						...
						while(rs2.next()){
							%>
									...
									<tr>
										...
										<td><button name="id" value="<%= id %>" type="submit" >view</button></td>
									</tr>
